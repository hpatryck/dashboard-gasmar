              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm h-[400px]">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={dados}>
                    ...
                    <Tooltip contentStyle={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '8px' }} labelFormatter={formatarHora} itemStyle={{ fontWeight: 600 }} />
        ...
        {telaAtiva === 'historico' && (
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center bg-white p-4 rounded-xl border border-slate-200 shadow-sm gap-4">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors w-full sm:w-auto justify-center">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm h-[600px] flex flex-col">
              <div className="mb-8">
                ...
                <p className="text-slate-500 text-sm mt-1">Análise de degradação estrutural do tanque ao longo do tempo.</p>
              </div>
